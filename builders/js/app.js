...
function nextCourseLinkHtml() {
  return `Ready for more? <a href="../creators/">Try AI for Creators</a> next.`;
}
  ...
  app.innerHTML = `
    ...
    <main class="certificate-page">
      ...
      ${
        ...
        <p class="cross-link no-print">Ready for more? <a href="../creators/">Try AI for Creators</a> next.</p>
      `
          : `
