...
function nextCourseLinkHtml() {
  return `Ready for more? <a href="../entrepreneurs/">Try AI for Entrepreneurs</a> next.`;
}
  ...
  app.innerHTML = `
    ...
    <main class="certificate-page">
      ...
      ${
        ...
        <p class="cross-link no-print">Ready for more? <a href="../entrepreneurs/">Try AI for Entrepreneurs</a> next.</p>
      `
          : `
